...
if(isset($_POST['docsub1'])){
	...
	// SSE-SECURITY-FIX: secure doctor authentication with prepared statement and password compatibility verification.
	$dname=sse_clean_input($_POST['username3']);
	$dpass=sse_clean_input($_POST['password3']);
    ...
    while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
	      if(!sse_verify_password_compat($dpass, $row['password'])) {
	        continue;
	      }
	      $authenticatedDoctor = true;
