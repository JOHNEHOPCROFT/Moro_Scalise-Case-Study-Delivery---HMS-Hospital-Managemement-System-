...
if(isset($_POST['doctor_search_submit']))
{
	...
	// SSE-SECURITY-FIX: parameterize doctor search and hide password data.
	$contact=sse_clean_input($_POST['doctor_contact']);
  ...
  if(!$row || ($row['username']=="" && $row['email']=="" && $row['docFees']=="")){
