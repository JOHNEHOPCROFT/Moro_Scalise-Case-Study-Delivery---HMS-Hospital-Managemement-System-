<?php require_once __DIR__ . '/include/session_bootstrap.php'; require_once __DIR__ . '/include/security_utils.php'; ?>
<html>
<head>
	<title>HMS</title>
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <form method="post" action="func2.php" autocomplete="off">
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="Your Phone *" autocomplete="off"  />
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Confirm Password *" id="cpassword" name="cpassword" autocomplete="new-password" onkeyup='check();' required/>
                                        </div>
                                        <input type="hidden" name="csrf_token" value="<?php echo sse_e(sse_generate_csrf_token()) ?>" />
                                        <input type="submit" class="btnRegister"  onclick="return checklen();" name="patsub1" value="Register"/>
                                    </div>
