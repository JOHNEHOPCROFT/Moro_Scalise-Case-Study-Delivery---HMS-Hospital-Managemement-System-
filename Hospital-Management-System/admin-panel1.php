...
sse_require_authenticated_admin('index.php');
...
if(isset($_POST['docsub']))
{
  ...
  $dpassword=sse_clean_input($_POST['dpassword']);
  $demail=sse_clean_input($_POST['demail']);
  $spec=sse_clean_input($_POST['special']);
  $docFees=(int) $_POST['docFees'];
  $hashedPassword = sse_hash_password_if_needed($dpassword);
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade" id="list-doc" role="tabpanel" aria-labelledby="list-home-list">
              ...
              <div class="col-md-8">
      <form class="form-group" action="doctorsearch.php" method="post" autocomplete="off">
        <div class="row">
                  ...
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      echo "<tr>
                        ...
                        <td>".htmlspecialchars((string) $spec, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $email, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $docFees, ENT_QUOTES, 'UTF-8')."</td>
                      </tr>";
                    }
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
       ...
       <div class="col-md-8">
      <form class="form-group" action="patientsearch.php" method="post" autocomplete="off">
        <div class="row">
                  ...
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      echo "<tr>
                        ...
                        <td>".htmlspecialchars((string) $fname, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $lname, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $gender, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $email, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $contact, ENT_QUOTES, 'UTF-8')."</td>
                        <td>[REDACTED]</td>
                      </tr>";
                    }
                ...
                <tbody>
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      echo "<tr>
                        <td>".htmlspecialchars((string) $doctor, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $pid, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $ID, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $fname, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $lname, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $appdate, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $apptime, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $disease, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $allergy, ENT_QUOTES, 'UTF-8')."</td>
                        <td>".htmlspecialchars((string) $pres, ENT_QUOTES, 'UTF-8')."</td>
                      </tr>";
                    }
      ...
      <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-pat-list">
         ...
         <div class="col-md-8">
      <form class="form-group" action="appsearch.php" method="post" autocomplete="off">
        <div class="row">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo htmlspecialchars((string) $row['gender'], ENT_QUOTES, 'UTF-8');?></td>
                        <td><?php echo htmlspecialchars((string) $row['email'], ENT_QUOTES, 'UTF-8');?></td>
                        <td><?php echo htmlspecialchars((string) $row['contact'], ENT_QUOTES, 'UTF-8');?></td>
                        <td><?php echo htmlspecialchars((string) $row['doctor'], ENT_QUOTES, 'UTF-8');?></td>
                        <td><?php echo htmlspecialchars((string) $row['docFees'], ENT_QUOTES, 'UTF-8');?></td>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
       ...
       <div class="tab-pane fade" id="list-mes" role="tabpanel" aria-labelledby="list-mes-list">
         ...
         <div class="col-md-8">
      <form class="form-group" action="messearch.php" method="post" autocomplete="off">
        <div class="row">
